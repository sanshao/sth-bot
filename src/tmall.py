...
def process_tmall_file(file_path, target_directory):
    ...
    category_mapping = {
        ...
        "淘宝-百亿服务费":["百亿补贴软件服务费"],
        "天猫-保险费":["消费者体验提升计划服务费"],
        "天猫-保证金解冻":["天猫消费者保证金-解冻"],
        "天猫-保证金赔付": ["天猫保证金-充值（代扣）-延迟发货", "天猫保证金-充值（代扣）-缺货", "天猫保证金-充值（代扣）-红包冻结", "天猫保证金-充值（代扣）-未按时开具发票"],
        "天猫-返点积分": ["代扣返点积分"],
        "天猫-官方竞价软件费":["官方竞价软件服务费"],
        "天猫-好评返现": ["支付宝转账小额打款-关联订单号", "支付宝转账小额打款-未关联"],
        "天猫-基础软件服务费":["基础软件服务费", "淘宝天猫跨境服务基础费"],
        "天猫-交易退款":["消费者保证金-交易售后", "售后退款-"],
        "天猫-保证金退款":["保证金退款"],
        "天猫-首单拉新":["天猫新客礼金技术服务费", "品牌新享天猫老客礼金软件服务费", "品牌新享天猫限时礼金软件服务费", "品牌新享-首单拉新计划", "品牌新享新品孵化软件服务费"],
        "天猫-淘宝客佣金":["淘宝客佣金代扣款", "淘宝联盟推广佣金返还", "淘宝联盟佣金代扣"],
        "天猫-天猫佣金": ["扣款用途：天猫佣金"],
        "天猫-万相台充值":["万相台无界版自动充值"],
        "天猫-转运物流费":["商家集运中转操作费", "商家集运物流服务费"],
        "一大包零食-交易收款": ["DDD商家结算款"],
        "一大包零食-首单拉新": ["扣款用途：DDD品牌新享服务费"],
        "一大包零食-淘客佣金": ["扣款用途：DDD淘客佣金"],
        "一大包零食-延迟发货": ["扣款用途：DDD商家扣款"],
    ...
    new_file_name = f"{os.path.splitext(base_name)[0]}.xlsx"  
